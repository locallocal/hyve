...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(botName) => "删除机器人会删除对应的聊天记录，确定要删除 ${botName} 吗？";

  static String m7(botName) => "删除聊天会清空所有的聊天记录，确定要删除与 ${botName} 的聊天吗？";

  static String m8(name) => "确定删除“${name}”？缓存的工具目录和安全凭据也会一并移除。";

  static String m9(name) => "确定卸载技能“${name}”？相关智能体绑定也会被移除。";

  static String m10(year) => "© ${year} Hyve 团队";

  static String m11(error) => "创建聊天失败：${error}";

  static String m12(error) => "创建项目失败：${error}";

  static String m13(error) => "删除项目失败：${error}";

  static String m14(milliseconds) => "${milliseconds} 毫秒";

  static String m15(seconds) => "${seconds} 秒";

  static String m16(name) => "允许“${name}”将已声明的脚本注册为工具。每次调用仍需审批，并在桌面沙箱中运行。";

  static String m17(count) => "${count} 个文件";

  static String m18(error) => "生成图片失败: ${error}";

  static String m19(error) => "生成音乐失败：${error}";

  static String m20(error) => "生成语音失败：${error}";

  static String m21(error) => "生成视频失败：${error}";

  static String m22(count) => "${count} 项";

  static String m23(language) => "语言已设置为${language}";

  static String m24(error) => "MCP 连接失败：${error}";

  static String m25(count) => "${count} 个（值已隐藏）";

  static String m26(minutes) => "${minutes}分钟前";

  static String m27(count) => "成功获取${count}个模型";

  static String m28(count) => "${count} 次命令执行";

  static String m29(duration) => "耗时 ${duration}";

  static String m30(count) => "${count} 条文件状态";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "createProject": MessageLookupByLibrary.simpleMessage("创建项目"),
    ...
    "messageHint": MessageLookupByLibrary.simpleMessage("输入消息，使用 @ 提及智能体..."),
    ...
    "selectAtLeastOneBot": MessageLookupByLibrary.simpleMessage("请至少选择一个智能体。"),
